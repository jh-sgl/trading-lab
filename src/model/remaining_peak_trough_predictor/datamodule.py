...
@register_datamodule("RemainingPeakTroughPredictor")
class RemainingPeakTroughPredictorDataModule(L.LightningDataModule):
    def __init__(
        self,
    ...
    @property
    def train_price_move_mean(self) -> float:
        return self._train_dataset.price_move_mean

    @property
    def train_price_move_std(self) -> float:
        return self._train_dataset.price_move_std
