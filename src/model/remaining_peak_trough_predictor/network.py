...
@register_network("RemainingPeakTroughPredictorV1")
class RemainingPeakTroughPredictorV1(nn.Module):
    """
...
@register_network("RemainingPeakTroughPredictorV2")
class RemainingPeakTroughPredictorV2(nn.Module):
    """
    Paper link: https://arxiv.org/pdf/2205.13504.pdf
    """
...
@register_network("RemainingPeakTroughPredictorMLPDropout")
class RemainingPeakTroughPredictorMLPDropout(nn.Module):
    def __init__(self, num_inputs, use_repr: bool, num_outputs=3, drop_prob=0.3, *args, **kwargs):
        super().__init__()
        if use_repr:
            num_inputs += 384
