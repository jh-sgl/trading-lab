...
from .model import ExtremaDetectorModel
...
@register_callback("ExtremaDetectorBacktester")
class ExtremaDetectorBacktesterCallback(L.Callback):
    def __init__(
        self,
    ...
    def on_validation_end(self, trainer: L.Trainer, pl_module: ExtremaDetectorModel) -> None:
...
class ExtremaDetectorBacktester:
    def __init__(
        self,
        tick_slippage_size: float,
        commission_rate: float,
