...
@register_callback("SharpeExtremaDetectorBacktester")
class SharpeExtremaDetectorBacktesterCallback(L.Callback):
    def __init__(
        self,
        ...
        super().__init__()
        self._backtester = SharpeExtremaDetectorBacktester(
            tick_slippage_size,
            commission_rate,
            price_multiplier,
            initial_balance,
    ...
    def on_validation_end(self, trainer: L.Trainer, pl_module: SharpeExtremaDetectorModel) -> None:
...
class SharpeExtremaDetectorBacktester:
    def __init__(
        self,
        tick_slippage_size: float,
        commission_rate: float,
