...
@register_network("ReprExtremaDetectorV1")
class ReprExtremaDetectorV1(nn.Module):
    """
...
@register_network("ReprExtremaDetectorV2")
class ReprExtremaDetectorV2(nn.Module):
    """
    Paper link: https://arxiv.org/pdf/2205.13504.pdf
    """
...
@register_network("ReprExtremaDetectorMLPDropout")
class ReprExtremaDetectorMLPDropout(nn.Module):
