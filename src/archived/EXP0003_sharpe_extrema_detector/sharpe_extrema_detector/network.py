...
@register_network("SharpeExtremaDetectorV1")
class SharpeExtremaDetectorV1(nn.Module):
    """
...
@register_network("SharpeExtremaDetectorV2")
class SharpeExtremaDetectorV2(nn.Module):
    """
    Paper link: https://arxiv.org/pdf/2205.13504.pdf
    """
