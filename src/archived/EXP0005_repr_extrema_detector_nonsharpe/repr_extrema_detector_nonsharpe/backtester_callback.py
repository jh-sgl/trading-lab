...
from .model import ReprExtremaDetectorNonsharpeModel
...
@register_callback("ReprExtremaDetectorNonsharpeBacktester")
class ReprExtremaDetectorNonsharpeBacktesterCallback(L.Callback):
    def __init__(
        self,
        ...
        super().__init__()
        self._backtester = ReprExtremaDetectorNonsharpeBacktester(
            tick_slippage_size,
            commission_rate,
            price_multiplier,
            initial_balance,
    ...
    def on_validation_end(self, trainer: L.Trainer, pl_module: ReprExtremaDetectorNonsharpeModel) -> None:
...
class ReprExtremaDetectorNonsharpeBacktester:
    def __init__(
        self,
        tick_slippage_size: float,
        commission_rate: float,
    ...
    def run_backtest(self, df: pd.DataFrame, ignore_cost: bool = False) -> pd.DataFrame:
        ...
        backtest_result = self._create_result_dataframe(
            df[DataKey.TIMESTAMP], position, contract_cost, df[DataKey.PRICE_ENTER], profit
        )
