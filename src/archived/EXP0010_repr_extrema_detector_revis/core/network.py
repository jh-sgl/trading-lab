...
class Nonlinear(nn.Module):
    def __init__(
        ...
        self._seasonal_layer = LinearBatchRelu(self._input_ch, hidden_dim, lookback_num)
        self._trend_layer = LinearBatchRelu(self._input_ch, hidden_dim, lookback_num)
...
class MLPDropout(nn.Module):
    def __init__(self, input_ch, hidden_dim, num_outputs, lookback_num, drop_prob, use_repr, *args, **kwargs):
        ...
        self.linear_1 = init_(torch.nn.Linear(self._input_ch * lookback_num, self._num_outputs))
        # self.linear_1 = init_(torch.nn.Linear(self._input_ch * lookback_num, hidden_dim))
