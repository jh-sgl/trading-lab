...
@register_callback("ExtremaDetectorRevisBacktester")
class ExtremaDetectorRevisBacktesterCallback(L.Callback):
    def __init__(
        self,
        ...
        super().__init__()
        self._backtester = ExtremaDetectorRevisBacktester(
            tick_slippage_size,
            commission_rate,
            price_multiplier,
            initial_balance,
    ...
    def on_validation_end(self, trainer: L.Trainer, pl_module) -> None:
        ...
        total_df = total_df[total_df[Key.OUTPUT_PRED].notna()].copy()
...
class ExtremaDetectorRevisBacktester:
    def __init__(
        self,
        tick_slippage_size: float,
        commission_rate: float,
