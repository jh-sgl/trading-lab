...
class DFKey:
    ...
    # Special column for geneventfilter
    EVENT_MASK: tuple[str, str] = ("event_mask", "__NA__")
    ...
    ADJ_CALL_1_VOLUME: tuple[str, str] = ("adj_call_1_volume", "volume")
    ADJ_CALL_2_VOLUME: tuple[str, str] = ("adj_call_2_volume", "volume")
    ADJ_CALL_3_VOLUME: tuple[str, str] = ("adj_call_3_volume", "volume")
    ADJ_CALL_4_VOLUME: tuple[str, str] = ("adj_call_4_volume", "volume")
    ADJ_CALL_5_VOLUME: tuple[str, str] = ("adj_call_5_volume", "volume")

    ADJ_PUT_1_VOLUME: tuple[str, str] = ("adj_put_1_volume", "volume")
    ADJ_PUT_2_VOLUME: tuple[str, str] = ("adj_put_2_volume", "volume")
    ADJ_PUT_3_VOLUME: tuple[str, str] = ("adj_put_3_volume", "volume")
    ADJ_PUT_4_VOLUME: tuple[str, str] = ("adj_put_4_volume", "volume")
    ADJ_PUT_5_VOLUME: tuple[str, str] = ("adj_put_5_volume", "volume")
