...
from .raw_preprocessing_module import RawPreprocessingModuleBase
from .resample_preprocessing_module import ResamplePreprocessingModuleBase
        ...
        def _run_resample_preprocessing_pipeline(
            ...
            for resample_rule in self._resample_rules:
                ...
                result_df = self._create_empty_resampled_df(
                    raw_preprocessed_df, resample_rule, cols_to_create
                )
                ...
                result_df[("resample_rule", "__NA__")] = resample_rule
