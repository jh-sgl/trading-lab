...
if __name__ == "__main__":
    ...
    basic_preprocessor = BasicPreprocessor(
        ...
        raw_data_dir="/data/jh/repo/trading-lab/data/raw/20250623_option_oi_added_qqqeck/",
        ray_actor_num=48,
        save_fp="/data/jh/repo/trading-lab/data/preprocessed_jh/v7_factor_factory.parquet",
        debug=args.debug,
    )
