...
class BasicDataModule(L.LightningDataModule):
    ...
    def train_date_range(self) -> tuple[str, str]:
        return self._train_dataset.date_range

    @property
    def val_date_range(self) -> tuple[str, str]:
        return self._val_dataset.date_range

    @property
    def val_strategy(self) -> pd.DataFrame:
        return self._val_dataset.strategy

    @property
    def val_strategy_df(self) -> pd.DataFrame:
        return self._val_dataset.strategy_df
