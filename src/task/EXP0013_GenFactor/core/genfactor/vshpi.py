...
class VSHPI(GenFactor):
    ...
    description = """
        ...
        - Non-linear sentiment flow: Changes in skew and OI often signal rebalancing flows before they show in price.
        - Dealer positioning: Dealers hedging short gamma or vanna exposures must buy/sell the underlying as price/volatility shifts.
        - Asymmetry insight: Captures when the market is more sensitive to moves in one direction due to options' shape.
    """
