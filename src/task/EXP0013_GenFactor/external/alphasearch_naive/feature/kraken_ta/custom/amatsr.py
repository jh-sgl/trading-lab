...
def amatsr(close=None, fast=None, slow=None, mamode=None, offset=None, **kwargs):
    ...
    mas_short = decreasing(fast_ma, lookback) & increasing(slow_ma, lookback)
    ...
    mas_short.name = f"AMAT{mamode[0]}_SR_{fast}_{slow}_{lookback}"
    mas_short.category = "trend"
