...
def vidya(close, length=None, drift=None, offset=None, **kwargs):
    ...
    def _cmo(source: Series, n: int, d: int):
        ...
        For some reason: from task.EXP0013_GenFactor.external.alphasearch_naive.feature.kraken_ta.momentum import cmo causes
        alphasearch_naive.feature.kraken_ta.momentum.coppock to not be able to import it's
        wma like from task.EXP0013_GenFactor.external.alphasearch_naive.feature.kraken_ta.overlap import wma?
