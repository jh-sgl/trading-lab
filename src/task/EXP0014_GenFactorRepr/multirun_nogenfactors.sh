#!/bin/bash
RUN_NAME_PREFIX="multirun_24_fixzerograd"

MAX_JOBS=3
MAX_RETRIES=50
SLEEP_BETWEEN_JOBS=100
JOB_COUNT=0

# ta_worked_well_with_1min_first
EXPERIMENTS=(
  5e273fc1 000a54a0 5adba56b 5b956bc9 82b701fe 312cd9f5 
  # 852ae00c b7ab602f c39df009 ea8ca645 a11f5653 5817bc20
  # 4cec70f3 752e0dc3 124783a5 6ce8d902 34076097 69d4cb14
  #bcdcee71 161ae57f ce4e3f24 bc8cb06d 77011b70 c37c39d6 
  #ddd70767 5c74213d d70a2979 f40378a0 cca6152b d4d0f8bd
  #b65464ca 06d87f5c
)
